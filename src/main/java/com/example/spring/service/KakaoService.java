...
import com.example.spring.advice.exception.CommunicationException;
import com.example.spring.model.social.KakaoProfile;
import com.example.spring.model.social.RetKakaoAuth;
...
public class KakaoService {
    ...
    public KakaoProfile getKakaoProfile(String accessToken){
        // Set header: Content-type: application/x-www-from-urlencoded
    ...
    public RetKakaoAuth getKakaoTokenInfo(String code) {
        // Set header: Content-type: application/x-www-form-url-urlencoded
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_FORM_URLENCODED);
        // Set parameter
